...
FULL_COMMAND_ORDER = PREMERGE_COMMAND_ORDER + [COMMAND_DEMO_EVIDENCE_FULL_EXPORT]

PREMERGE_REQUIRED_COMMANDS = set(PREMERGE_COMMAND_ORDER)
FULL_REQUIRED_COMMANDS = set(FULL_COMMAND_ORDER)
